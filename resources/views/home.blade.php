...
<body>
            ...
            <form method="POST" action="/room">
                <div class="d-flex justify-content-center mt-5 fs-4">
                    <div class="row w-75">
                        ...
                        <div
                            class="col-12 mt-5 mt-md-0 col-xl-4 col-lg-4 col-md-4 col-sm-6 d-flex align-items-center justify-content-center">
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 12vh;">
            ...
            <div class="col-12 col-xl-6 col-lg-6 mt-5 load-hidden ">
                <div class="ratio ratio-16x9">
                    <iframe width="380" height="280" src="https://www.youtube.com/embed/8k4Cobts1sU"
                        title="YouTube video player" fram="0"
    ...
    <div class="col-12 col-xl-12 row g-0">
    ...
    <div class="" style="margin-top: 15vh;">
        <div class="w-100 mx-auto text-center text-primary">
            <div class="d-flex justify-content-center">
                <div class="d-inline-block text-primary">
            ...
            <div class="my-5 p-3">
                <div class="ratio ratio-4x3 mx-auto" style="max-width: 50%; min-width: 70%;">
                    <iframe class="responsive-iframe load-hidden "
                        src="https://www.google.com/maps/d/embed?mid=1CfPjuzypOtY3C585huizNXOnMww&hl=es"></iframe>
                </div>
            </div>
        </div>
    ...
    <div class="clientRate pt-4 pb-4 d-flex align-items-center justify-content-center text-white text-center border load-hidden "
    ...
    <div class="mt-5 load-hidden ">
        <div class="ratio ratio-16x9">
            <iframe src="https://www.youtube.com/embed/JxR_SPj4BEg?controls=0" title="YouTube video player" fram="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
        </div>
    </div>
    <div class="comments pt-5 pb-5 load-hidden ">
        <div class="d-flex justify-content-center">
            <div class="d-inline-block text-primary">
        ...
        <form action="sendHotel.php" method="post">
            <div class="doubsForm row mt-5 mx-auto">
                ...
                <div class="">
                    <button class="form-control mx-auto" type="submit" id="transDoubs2"
                        style="width: 140px;">Enviar</button>
                </div>
            </div>
        </form>
    </div>
