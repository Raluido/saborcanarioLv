                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="{{ Storage::url('/media/' . 'Suit2.jpg') }}"
                                            width="400" height="500" alt="First slide">
                                    </div>
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="{{ Storage::url('/media/' . 'Suit4.jpg') }}"
                                            width="400" height="500" alt="Second slide">
                                    </div>
                                </div>
                                        ...
                                        <form method="POST" action="/showRoom/{idRoom}" id="payment-form">
                                            ...
                                            <div class="mb-2">
                                                <textarea class="form-control" name="comment" id="comment"
                                                    rows="3">Comentarios...</textarea><br><br>
                                            </div>
                                            <div class="mt-4 d-flex">
                                                ...
                                                <div class="">
                                                    <input type="text" id="total_amount" name="total_amount"
                                                        label="total_amount" value="" /><br><br>
                                                </div>
                                            </div>
            ...
            @elseif($room->idRoom != 1)
                <div class="d-flex justify-content-center">
                    <div class="d-flex">
                        <div class="d-flex justify-content-center mb-5 mt-5">
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="img-fluid"
                                            src="{{ Storage::url('/media/' . 'Habitación Doble1.jpg') }}" width="400"
                                            height="500">
                                    </div>
                                    <div class="carousel-item active">
                                        <img class="img-fluid"
                                            src="{{ Storage::url('/media/' . 'Habitación Doble2.jpg') }}" width="400"
                                            height="500">
                                    </div>
                                </div>
                                <a class="carousel-control-prev" href="#carouselExampleControls" role="button"
                        ...
                        <div class="d-flex w-75" style="border: 1px solid red">
                            <div class="w-100" style="border: 1px solid black">
                                @if (Auth::user())
                                <div class="text-primary">
                                    <h3>Detalles de la reserva</h3>
